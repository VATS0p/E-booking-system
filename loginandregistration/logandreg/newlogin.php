...
<head>
    ...
    <!-- Title Page-->
    <title>APPOINTMENTLELO-Login</title>
                ...
                <div class="card-body">
                    ...
                    <form method="POST">                        
                        <div class="input-group">
                            <input class="input--style-1"type="text" name="usernameemail" placeholder="Username or Email" id = "usernameemail" required value="">
                        </div>
                        ...
                        <div class="p-t-20">
                            <input class="btn btn--radius btn--green" type="submit" name="submit" value="Login">
                        </div>
                    </form>
                </div>
            </div>
